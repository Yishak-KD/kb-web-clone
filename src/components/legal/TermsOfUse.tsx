const TermsOfUse = () => {
  return (
    <div className="px-28 w-4/5 mx-auto py-8">
      <p className="text-lg mb-4">Effective as of May 28, 2020.</p>
      <p className="text-lg mb-4">
        By using Kedus Bible sites, services, and mobile applications (together,
        Kedus Bible), whether as a guest or a registered user, you accept and
        agree to bound by these Terms. Please read these Terms carefully before
        you start to use Kedus Bible, as well as the Kedus Bible Privacy Policy.
        If you do not agree to these Terms or the Kedus Bible Privacy Policy you
        must not access or use Kedus Bible.
      </p>
      <h5 className="text-xl mb-2">Changes to the Terms</h5>
      <p className="text-lg mb-4">
        Kedus Bible is offered by Aevue LLC (“Kedus Bible”,
        “we” or “us”). We may revise and update these Terms from time to time at
        our sole discretion. Any changes are effective when we post them. Your
        continued use of Kedus Bible following the posting of revised Terms
        means that you accept and agree to the changes.
      </p>
      <h5 className="text-xl mb-2">Privacy Policy</h5>
      <p className="text-lg mb-4">
      ...
      <h5 className="text-xl mb-2">Use Restrictions</h5>
      <p className="text-lg mb-4">
      ...
      <ul className="list-disc pl-8 mb-4">
        ...
        <li>
          in any manner that could disable, overburden, damage, or impair Kedus
          Bible or interfere with any other person’s use of Kedus Bible;
        </li>
        <li>
        ...
        <li>
          to attack Kedus Bible via a denial-of-service attack or a distributed
      ...
      <ul className="list-disc pl-8 mb-4">
        ...
        <li>
          ...
          Aevue LLC or any other person or entity, if this is not the case.
        </li>
        <li>
      ...
      <p>
        ...
        our Service, please contact us at http://kedusbible.com.
      </p>
      ...
      <p>
        The Thoughts/Reflection on the daily devotions are written by Phil Ware in English and translated to Amharic.
        You can email questions or comments to phil@verseoftheday.com.
      </p>
      ...
      <p>
        ...
        POLICY AT http://kedusbible.com REPRESENT THE COMPLETE AND EXCLUSIVE
      ...
      <p>
        Kedus Bible is operated by Aevue LLC, a Marland limited liability
        company. All feedback, comments, requests for technical support and
        other communications relating to Kedus Bible should be directed to:
        Kedus Bible support at suppor@kedusbible.com.
      </p>
    </div>
  );
};
