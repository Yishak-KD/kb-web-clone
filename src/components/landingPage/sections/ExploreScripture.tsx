...
const ExploreScripture = () => {
    return (
        <div className="relative w-full lg:px-40 px-8 mx-auto lg:grid lg:grid-cols-2" id="features">
            <img src="/images/ellipse3.svg" alt="" className="absolute z-0 top-24 left-[-15px]" />
